...
mod tests {
    ...
    fn test_export_import_roundtrip() {
        let mut c = Conversation::new();
        c.messages.push(Message { role: "user".into(), content: "你好".into() });
        c.messages.push(Message { role: "assistant".into(), content: "您好！有什么我可以帮您的吗？".into() });
